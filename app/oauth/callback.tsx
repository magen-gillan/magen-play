    ...
    const handleCallback = async () => {
      ...
      try {
        ...
        if (params.code && params.state) {
          ...
          // Parse the callback URL without logging credentials or query parameters.
          // Parse from URL
          try {
            ...
            // Values are intentionally kept out of logs because they are credentials.
          } catch (e) {
            console.log(
        ...
        console.log("[OAuth] Exchanging callback credentials securely...");
